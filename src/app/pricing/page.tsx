                    ...
                    <div className="container">
                        ...
                        <div className={styles.logoGrid}>
                            {featuredEvents.map(event => (
                                <Link prefetch={false} key={event.id} href={`/events/${event.slug || event.id}`} className={styles.eventPoster}>
            ...
            <section className={styles.stepsSection}>
                <div className="container">
                    ...
                    <div className={styles.ctaWrapper}>
                        <Link prefetch={false} href="/organizer/create" className={styles.mainCta}>
